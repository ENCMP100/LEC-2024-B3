...
friends.insert(-1, 'Peter') # insert at the last position
...
#print all indicies of the word 'butter'
print("Indicies of all occurrences of the word butter:")
i = 0
while True:
    if 'butter' in twister[i:]:
        i = twister.index('butter', i)
        print(i)
        i = i + 1
    else:
        break;
